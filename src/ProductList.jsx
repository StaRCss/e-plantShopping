...
import { selectTotalQuantity } from './CartSlice'; // Adjust the path if needed
...
function ProductList() {
    ...
    const totalQuantity = useSelector(selectTotalQuantity); // Get total number of items in the cart
...
const handlePlantsClick = (e) => {
   ...
   const handleContinueShopping = () => {
    ...
    <CartItem onContinue={handleContinueShopping}/>
)}
    </div>
    );
}
